export class Mobilenetv212StaticNchw {
  ...
  async build(contextOptions) {
    ...
    // Load weights ArrayBuffer from mobilenetv2-12-static_nchw.bin
    async function loadWeightsArrayBuffer() {
        const response = await fetch('mobilenetv2-12-static_nchw.bin');
        if (!response.ok) {
    ...
    const var_474 = builder.conv2d(
        input, var_475,
        {
            bias: var_476, strides: [2, 2], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_477 = builder.conv2d(
        var_317, var_478,
        {
            bias: var_479, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 32
        }
    );
    ...
    const var_480 = builder.conv2d(
        var_320, var_481,
        {
            bias: var_482, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_483 = builder.conv2d(
        var_480, var_484,
        {
            bias: var_485, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_486 = builder.conv2d(
        var_325, var_487,
        {
            bias: var_488, strides: [2, 2], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 96
        }
    );
    ...
    const var_489 = builder.conv2d(
        var_328, var_490,
        {
            bias: var_491, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_492 = builder.conv2d(
        var_489, var_493,
        {
            bias: var_494, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_495 = builder.conv2d(
        var_333, var_496,
        {
            bias: var_497, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 144
        }
    );
    ...
    const var_498 = builder.conv2d(
        var_336, var_499,
        {
            bias: var_500, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_501 = builder.conv2d(
        var_339, var_502,
        {
            bias: var_503, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_504 = builder.conv2d(
        var_342, var_505,
        {
            bias: var_506, strides: [2, 2], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 144
        }
    );
    ...
    const var_507 = builder.conv2d(
        var_345, var_508,
        {
            bias: var_509, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_510 = builder.conv2d(
        var_507, var_511,
        {
            bias: var_512, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_513 = builder.conv2d(
        var_350, var_514,
        {
            bias: var_515, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 192
        }
    );
    ...
    const var_516 = builder.conv2d(
        var_353, var_517,
        {
            bias: var_518, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_519 = builder.conv2d(
        var_356, var_520,
        {
            bias: var_521, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_522 = builder.conv2d(
        var_359, var_523,
        {
            bias: var_524, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 192
        }
    );
    ...
    const var_525 = builder.conv2d(
        var_362, var_526,
        {
            bias: var_527, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_528 = builder.conv2d(
        var_365, var_529,
        {
            bias: var_530, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_531 = builder.conv2d(
        var_368, var_532,
        {
            bias: var_533, strides: [2, 2], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 192
        }
    );
    ...
    const var_534 = builder.conv2d(
        var_371, var_535,
        {
            bias: var_536, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_537 = builder.conv2d(
        var_534, var_538,
        {
            bias: var_539, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_540 = builder.conv2d(
        var_376, var_541,
        {
            bias: var_542, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 384
        }
    );
    ...
    const var_543 = builder.conv2d(
        var_379, var_544,
        {
            bias: var_545, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_546 = builder.conv2d(
        var_382, var_547,
        {
            bias: var_548, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_549 = builder.conv2d(
        var_385, var_550,
        {
            bias: var_551, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 384
        }
    );
    ...
    const var_552 = builder.conv2d(
        var_388, var_553,
        {
            bias: var_554, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_555 = builder.conv2d(
        var_391, var_556,
        {
            bias: var_557, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_558 = builder.conv2d(
        var_394, var_559,
        {
            bias: var_560, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 384
        }
    );
    ...
    const var_561 = builder.conv2d(
        var_397, var_562,
        {
            bias: var_563, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_564 = builder.conv2d(
        var_400, var_565,
        {
            bias: var_566, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_567 = builder.conv2d(
        var_403, var_568,
        {
            bias: var_569, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 384
        }
    );
    ...
    const var_570 = builder.conv2d(
        var_406, var_571,
        {
            bias: var_572, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_573 = builder.conv2d(
        var_570, var_574,
        {
            bias: var_575, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_576 = builder.conv2d(
        var_411, var_577,
        {
            bias: var_578, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 576
        }
    );
    ...
    const var_579 = builder.conv2d(
        var_414, var_580,
        {
            bias: var_581, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_582 = builder.conv2d(
        var_417, var_583,
        {
            bias: var_584, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_585 = builder.conv2d(
        var_420, var_586,
        {
            bias: var_587, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 576
        }
    );
    ...
    const var_588 = builder.conv2d(
        var_423, var_589,
        {
            bias: var_590, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_591 = builder.conv2d(
        var_426, var_592,
        {
            bias: var_593, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_594 = builder.conv2d(
        var_429, var_595,
        {
            bias: var_596, strides: [2, 2], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 576
        }
    );
    ...
    const var_597 = builder.conv2d(
        var_432, var_598,
        {
            bias: var_599, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_600 = builder.conv2d(
        var_597, var_601,
        {
            bias: var_602, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_603 = builder.conv2d(
        var_437, var_604,
        {
            bias: var_605, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 960
        }
    );
    ...
    const var_606 = builder.conv2d(
        var_440, var_607,
        {
            bias: var_608, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_609 = builder.conv2d(
        var_443, var_610,
        {
            bias: var_611, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_612 = builder.conv2d(
        var_446, var_613,
        {
            bias: var_614, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 960
        }
    );
    ...
    const var_615 = builder.conv2d(
        var_449, var_616,
        {
            bias: var_617, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_618 = builder.conv2d(
        var_452, var_619,
        {
            bias: var_620, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_621 = builder.conv2d(
        var_455, var_622,
        {
            bias: var_623, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 960
        }
    );
    ...
    const var_624 = builder.conv2d(
        var_458, var_625,
        {
            bias: var_626, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_627 = builder.conv2d(
        var_624, var_628,
        {
            bias: var_629, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
