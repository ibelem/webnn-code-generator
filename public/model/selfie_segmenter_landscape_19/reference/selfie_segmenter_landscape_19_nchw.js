export class SelfieSegmenterLandscape19Nchw {
  ...
  async build(contextOptions) {
    ...
    // Load weights ArrayBuffer from selfie_segmenter_landscape_19_nchw.bin
    async function loadWeightsArrayBuffer() {
        const response = await fetch('selfie_segmenter_landscape_19_nchw.bin');
        if (!response.ok) {
    ...
    const input = builder.input(
        'input',
        {dataType: 'float32', shape: [1, 144, 256, 3]}
    );
    ...
    const var_Conv__158_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_1_y_0, strides: [2, 2], padding: [0, 1, 0, 1], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__161_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_1_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__162_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_y_0, strides: [2, 2], padding: [0, 1, 0, 1], dilations: [1, 1], groups: 16
        }
    );
    ...
    const var_Conv__165_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_2_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__166_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_3_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__167_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_4_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__171_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_5_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__172_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_1_y_0, strides: [2, 2], padding: [0, 1, 0, 1], dilations: [1, 1], groups: 72
        }
    );
    ...
    const var_Conv__173_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_6_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__176_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_7_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__177_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_2_y_0, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 88
        }
    );
    ...
    const var_Conv__178_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_8_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__183_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_9_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__186_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_3_y_0, strides: [2, 2], padding: [1, 2, 1, 2], dilations: [1, 1], groups: 96
        }
    );
    ...
    const var_Conv__189_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_10_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__190_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_11_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__191_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_12_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__194_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_13_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__197_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_4_y_0, strides: [1, 1], padding: [2, 2, 2, 2], dilations: [1, 1], groups: 128
        }
    );
    ...
    const var_Conv__200_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_14_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__201_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_15_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__202_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_16_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__205_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_17_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__208_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_5_y_0, strides: [1, 1], padding: [2, 2, 2, 2], dilations: [1, 1], groups: 128
        }
    );
    ...
    const var_Conv__211_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_18_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__212_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_19_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__213_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_20_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__216_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_21_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__219_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_6_y_0, strides: [1, 1], padding: [2, 2, 2, 2], dilations: [1, 1], groups: 96
        }
    );
    ...
    const var_Conv__222_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_22_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__223_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_23_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__224_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_24_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__227_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_25_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__230_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_7_y_0, strides: [1, 1], padding: [2, 2, 2, 2], dilations: [1, 1], groups: 96
        }
    );
    ...
    const var_Conv__233_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_26_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__234_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_27_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__235_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_28_1_y_0, strides: [1, 1], padding: [0, 0, 0, 0], dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__238_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_30_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__239_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_29_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_289 = builder.resample2d(
        var_multiply_6_0,
        {
            mode: 'linear', scales: [2.0, 2.0], sizes: undefined
        }
    );
    ...
    const var_Conv__240_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_31_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__243_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_32_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__244_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_33_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__245_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_34_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__248_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_8_y_0, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 24
        }
    );
    ...
    const var_Conv__249_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_35_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__252_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_36_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__253_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_37_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__254_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_38_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__257_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_9_y_0, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 16
        }
    );
    ...
    const var_Conv__258_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_39_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__261_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_40_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__262_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_41_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__263_0 = builder.conv2d(
        ...
        {
            bias: var_conv2d_42_1_y_0, strides: [1, 1], padding: undefined, dilations: [1, 1], groups: 1
        }
    );
    ...
    const var_Conv__266_0 = builder.conv2d(
        ...
        {
            bias: var_depthwise_conv2d_10_y_0, strides: [1, 1], padding: [1, 1, 1, 1], dilations: [1, 1], groups: 16
        }
    );
    ...
    const var_conv2d_transpose_0 = builder.convTranspose2d(
        ...
        {
            bias: undefined, strides: [2, 2], padding: undefined, dilations: [1, 1], groups: undefined, outputSizes: [144, 256]
        }
    );
