...
export class MediapipeSelfieSegmentationSimplifiedNchw {
  ...
  async build(options) {
    ...
    const pixel_values = builder.input('pixel_values', { dataType: 'float32', shape: [1,3,256,256] });
    ...
    const var__reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/ReduceMean' }
    );
    ...
    const var__sub_block1_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/sub_block1/ReduceMean' }
    );
    ...
    const var__block1_sub_block_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/block1/sub_block/ReduceMean' }
    );
    ...
    const var__block2_sub_block_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/block2/sub_block/ReduceMean' }
    );
    ...
    const var__block3_sub_block_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/block3/sub_block/ReduceMean' }
    );
    ...
    const var__block4_sub_block_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/block4/sub_block/ReduceMean' }
    );
    ...
    const var__reducemean_1_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/ReduceMean_1' }
    );
    ...
    const var__final_block1_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/final_block1/ReduceMean' }
    );
    ...
    const var__final_block2_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/final_block2/ReduceMean' }
    );
    ...
    const var__final_block3_reducemean_output_0 = builder.reduceMean(
      ...
      { keepDimensions: true, axes: [2, 3], label: '/final_block3/ReduceMean' }
    );
    ...
    this.graph_ = await builder.build({ 'alphas': alphas });
