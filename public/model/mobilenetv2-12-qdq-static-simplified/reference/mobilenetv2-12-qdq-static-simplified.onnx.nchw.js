export class Mobilenetv212QdqStaticSimplifiednchw {
  ...
  async build(contextOptions) {
    ...
    // Load weights ArrayBuffer from mobilenetv2-12-qdq-static-simplified.onnx.nchw.bin
        async function loadWeightsArrayBuffer() {
            const response = await fetch('mobilenetv2-12-qdq-static-simplified.onnx.nchw.bin');
            if (!response.ok) {
